 ...
 * 
 */
public final class DragNDropAdapter2 extends BaseExpandableListAdapter{
	...
	public DragNDropAdapter2(Context context, Map<String, ArrayList<String>> child) {
		init(context, new int[] { android.R.layout.simple_list_item_1 },
				new int[] { android.R.id.text1 },child);
	}

	public DragNDropAdapter2(Context context, int[] itemLayouts, int[] itemIDs,
	...
	public void showToast(DragNDropListView2.Action swipeAction){

        if(swipeAction == DragNDropListView2.Action.LR)
